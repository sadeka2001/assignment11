            ...
            <form action="{{ route('product.update',$products->id) }}" method="post">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="quantity" class="form-control" name="quantity" id="quantity" value="{{ $products->quantity }}">
                </div>
                <div class="form-group">
                  <label for="price">Product Price</label>
                  <input type="price" class="form-control" name="price" id="price" value="{{ $products->price }}">
                </div>
              </div>
              <!-- /.card-body -->
